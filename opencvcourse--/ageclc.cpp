...
tuple<Mat, vector<vector<int>>> getFaceBox(Net net, Mat& frame, double conf_threshold)
{
    ...
    {
        string faceProto = "Camera Roll/opencv_face_detector.pbtxt";
        string faceModel = "Camera Roll/opencv_face_detector_uint8.pb";

        string ageProto = "Camera Roll/age_deploy.prototxt";
        string ageModel = "Camera Roll/age_net.caffemodel";

        string genderProto = "Camera Roll/gender_deploy.prototxt";
        string genderModel = "Camera Roll/gender_net.caffemodel";
        ...
        while (waitKey(1) < 0) {
            ...
            for (auto it = begin(bboxes); it != end(bboxes); ++it) {
                ...
                */
                ...
                imwrite("Camera Roll/out.jpg", frameFace);
            }
